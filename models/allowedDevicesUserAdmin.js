...
const AllowedDevicesUserAdminSchema = new mongoose.Schema(
    {
        ...
        UserAdmin_idUserAdmin: { type: mongoose.Schema.Types.ObjectId, ref: 'UserAdmin', autopopulate: true },
        // sourceIP: { type: String, maxlength: 45, required: true, unique: true },
        sourceIP: { type: String, maxlength: 45, required: true },
